...
public class HangManGame {
    ...
    public static void main(String[] args) {
        ...
        //by defult run the game
        String play = "yes";

        //counter to determine which player's turn it is to come up with word
        double count = 1;

        //run the game the number of times the players says 'yes' to playing it
        while (play.equals("yes")) {
            //if count is an odd number its player 1's turn to input a word
            if (!((count % 2) == 0)) {
                //telling the player to enter a word
                System.out.println("Player 1 enter a word for player 2 to guess.");
            }
            //if count is an even number its player 2's turn to input a word
            if (((count % 2) == 0)) {
                //telling the player to enter a word
                System.out.println("Player 2 enter a word for player 1 to guess.");
            }
            //new word
            ...
            while (word.contains("1") || word.contains("2") || word.contains("3") || word.contains("4") || word.contains("5") || word.contains("6") || word.contains("7") || word.contains("8") || word.contains("9") || word.contains("0") || word.contains("_") || word.contains("*") || word.contains("&") || word.contains("^") || word.contains("%") || word.contains("$") || word.contains("#") || word.contains("@") || word.contains("!") || word.contains("=") || word.contains("+") || word.contains("|") || word.contains(".") || word.contains("?") || word.contains("<") || word.contains(">")) {
                System.out.println("Sorry, but " + word + " is not a word. Please enter a new word:");
                word = input.nextLine();
            }
            String word2 = word;
            ...
            if (word2.contains("-") && incorrect > 0) {
                ...
                if (word.contains(guess2)) {
                    ...
                    //if the character at each position is not an astrix, replace it with a dash
                    for (int x = 0; x < word.length(); x++) {
                        if (word2.charAt(x) != '1' && word2.charAt(x) != '2') {
                            word2 = word2.replace(word2.charAt(x), '-');
            ...
            if (!(word2.contains("-")) && incorrect > 0) {
                ...
                //end program if they say no to playing again
                if (play.equals("no")) {
                    break;
                }

                //if they don not enter yes or no it keeps asking them for the correct input
                while (!(play.equals("yes"))) {
